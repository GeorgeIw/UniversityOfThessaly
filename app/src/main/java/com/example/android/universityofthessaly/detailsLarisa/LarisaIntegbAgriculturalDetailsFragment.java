...
public class LarisaIntegbAgriculturalDetailsFragment extends Fragment {

    public LarisaIntegbAgriculturalDetailsFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(requireActivity().getIntent().hasExtra("LarisaIntegbAgriculturalTeachers") || requireActivity().getIntent().hasExtra("LarisaIntegbAgriculturalAnnouncements")){
            ...
            webView.loadUrl("https://www.uth.gr/spoydes/proptychiakes/schools-departments/symboylio-entaxis/programma-spoydon-tmimatos-tehnologon-geoponon-tei-thessalias-larisa");
