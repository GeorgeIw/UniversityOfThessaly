...
public class LarisaIntegbCsDetailsFragment extends Fragment {

    public LarisaIntegbCsDetailsFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(requireActivity().getIntent().hasExtra("LarisaIntegbCsTeachers")){
            webView.setWebViewClient(new WebViewClient(){

                @Override
                public void onPageFinished(WebView view, String url) {
                    view.loadUrl("javascript:document.getElementById(\"resHeaderC\").setAttribute(\"style\",\"display:none;\");");
                    view.loadUrl("javascript:document.getElementById(\"resHeaderD\").setAttribute(\"style\",\"display:none;\");");
            ...
            webView.loadUrl("http://www.cs.teilar.gr/CS/PermamentTeachers.jsp");
            progressBar.setVisibility(View.GONE);

        } else if(requireActivity().getIntent().hasExtra("LarisaIntegbCsAnnouncements")){
            webView.setWebViewClient(new WebViewClient(){
            ...
            webView.loadUrl("http://www.cs.teilar.gr/CS/TeacherPAnn.jsp?Mynews=0&id=cs-praktika@teilar.gr#0");
            progressBar.setVisibility(View.GONE);
        }
