...
public class VolosPolitismIndustryDetailsFragment extends Fragment {

    public VolosPolitismIndustryDetailsFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(requireActivity().getIntent().hasExtra("VolosPolitismIndustryTeachers") || requireActivity().getIntent().hasExtra("VolosPolitismIndustryAnnouncements")){
            ...
            webView.loadUrl("https://www.uth.gr/spoydes/proptychiakes/schools-departments/sholi-anthropistikon-kai-koinonikon-epistimon/tmima-politismoy-kai-dimioyrgikon-meson-kai-biomihanion");
