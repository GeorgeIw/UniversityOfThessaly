...
public class VolosPrimaryEduDetailsFragment extends Fragment {

    public VolosPrimaryEduDetailsFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(requireActivity().getIntent().hasExtra("VolosPrimaryEduTeachers") || requireActivity().getIntent().hasExtra("VolosPrimaryEduAnnouncements")){
            ...
            webView.loadUrl("https://www.uth.gr/spoydes/proptychiakes/schools-departments/sholi-anthropistikon-kai-koinonikon-epistimon/paidagogiko-tmima-dimotikis-ekpaideysis");
